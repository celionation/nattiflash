        ...
        <div class="card card-body bg-light">
            ...
            <form action="" method="post">
                ...
                <div class="row g-3 my-1">
                    ...
                    <div class="col-md-3">
                        <?= Form::selectField('Gender', 'gender', $this->user->gender, $this->gender, ['class' => 'form-control'], ['class' => 'mb-3 col'], $this->errors); ?>
                    </div>
                </div>
                <div class="row g-3 my-1">
                    <div class="col-md-4">
                        <?= Form::inputField('State', 'state', $this->user->state, ['class' => 'form-control', 'type' => 'text'], ['class' => 'col mb-3'], $this->errors); ?>
                    </div>
                    <div class="col-md-4">
                        <?= Form::inputField('Country', 'country', $this->user->country, ['class' => 'form-control', 'type' => 'text'], ['class' => 'col mb-3'], $this->errors); ?>
                    </div>
                    <div class="col-md-4">
                        <?= Form::inputField('Address', 'address', $this->user->address, ['class' => 'form-control', 'type' => 'text'], ['class' => 'col mb-3'], $this->errors); ?>
                    </div>
                </div>
